...
TEST_CASE("stats::large rectArea","[weight=1][part=stats]"){
...
TEST_CASE("BOOYA GOAT","[weight=1][part=qtvar]"){
    PNG img;
    img.readFromFile("images/orig/Camaro.png");
    ...
    result.writeToFile("images/soln/goatVar.png");
}

TEST_CASE("GOAATe","[weight=1][part=qtvar]"){
    PNG img;
    img.readFromFile("images/orig/Camaro.png");
    ...
    result.writeToFile("images/soln/goatCount.png");
}
